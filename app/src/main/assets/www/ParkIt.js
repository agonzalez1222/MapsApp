...
function	setParkingLocation(){
			navigator.geolocation.getCurrentPosition(setParkingLocationSuccess,	locationError,
...
function	getParkingLocation(){
			navigator.geolocation.getCurrentPosition(getParkingLocationSuccess,	locationError,
{enableHighAccuracy:true});
}
...
function	showDirections(){
				...
				dService.route({
								...
								if(status	==	'OK'){
												...
												document.getElementById('directions').innerHTML	= '"https://maps.googleapis.com/maps/api/jskey=AIzaSyA2EmB3uVcsg3jOzfinO9IncWwQMmzfAVg"';
